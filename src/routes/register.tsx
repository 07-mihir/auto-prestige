      ...
      <div className="relative w-full max-w-2xl">
        ...
        <div className="glass-strong rounded-2xl p-6 sm:p-10 shadow-elegant">
          ...
          <div className="mt-8 grid grid-cols-2 gap-3">
            {[
              { id: "user", icon: User, title: "Buyer / Owner", desc: "Buy or sell occasionally" },
              {
                ...
                icon: Building2,
                title: "Dealer / Garage",
                desc: "Manage inventory at scale",
              },
            ].map((t) => {
              ...
              return (
                <button
                  key={t.id}
                  onClick={() => setType(t.id as "user" | "dealer")}
                  className={`text-left p-5 rounded-xl border-2 transition ${active ? "border-primary bg-primary/5" : "border-border hover:border-primary/30"}`}
                >
                  <t.icon
          ...
          <form className="mt-6 space-y-4" onSubmit={(e) => e.preventDefault()}>
            ...
            <Button
              size="lg"
              className="w-full rounded-lg gradient-primary text-primary-foreground shadow-glow"
            >

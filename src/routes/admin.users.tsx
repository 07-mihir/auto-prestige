          ...
          <tbody>
            {users.map((u, i) => (
              <tr key={i} className="border-t border-border/40">
                ...
                <td className="p-4">
                  <span className="px-2 py-0.5 rounded-md text-[11px] bg-secondary">{u[3]}</span>
                </td>
                <td className="p-4">
                  <span
                    className={`px-2 py-0.5 rounded-md text-[11px] font-semibold ${u[4] === "Active" || u[4] === "Verified" ? "bg-success/15 text-success" : u[4] === "Pending" ? "bg-warning/15 text-warning" : "bg-destructive/15 text-destructive"}`}
                  >
                    {u[4]}
                  </span>
                </td>

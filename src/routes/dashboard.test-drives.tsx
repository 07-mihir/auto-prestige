...
const drives = [
  {
    ...
    loc: "Royal Auto Mart, Mumbai",
    status: "Confirmed",
  },
  {
    car: "Mercedes GLE 300d",
    date: "Thu, May 14 · 4:30 PM",
    loc: "Sundaram Motors, Delhi",
    status: "Pending",
  },
  {
    car: "Hyundai Ioniq 5",
    date: "Sat, May 9 · 10:00 AM",
    loc: "Premier Cars, Pune",
    status: "Completed",
  },
];
        ...
        {drives.map((d, i) => (
          ...
          >
            ...
            <div className="flex items-center gap-3">
              <span
                className={`px-2.5 py-1 rounded-md text-xs font-semibold ${d.status === "Confirmed" ? "bg-success/15 text-success" : d.status === "Pending" ? "bg-warning/15 text-warning" : "bg-secondary text-muted-foreground"}`}
              >
                {d.status}
              </span>

...
export const Route = createFileRoute("/admin/dealers")({
  ...
  component: () => (
    <DashboardShell title="Platform Admin" subtitle="Control center" items={adminItems}>
      ...
      <div className="gradient-card glass rounded-2xl p-6"><p className="text-muted-foreground">Manage verified dealers, approve pending applications, and view performance.</p></div>
    </DashboardShell>
  ),
});